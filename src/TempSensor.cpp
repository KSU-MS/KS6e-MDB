...
uint16_t portPins[CHANNELS] = {CHANNEL1, CHANNEL2, CHANNEL3, CHANNEL4,
...
{
    uint16_t minTempM1 = this->Module_HALF1.senceTemp.temp[CHANNEL1];
    uint16_t minTempM2 = this->Module_HALF2.senceTemp.temp[CHANNEL1];
...
{
    uint16_t maxTempM1 = this->Module_HALF1.senceTemp.temp[CHANNEL1];
    uint16_t maxTempM2 = this->Module_HALF2.senceTemp.temp[CHANNEL1];
    for (int CHANNEL = 0; CHANNEL < (CHANNELS / 2); CHANNEL++)
    {
...
uint16_t *TempSensor::getTempModuleHALF1()
{
...
uint16_t *TempSensor::getTempModuleHALF2()
{
...
uint16_t TempSensor::getMinTempModuleHALF1()
{
    return this->Module_HALF1.senceTemp.minTemp;
}

uint16_t TempSensor::getMinTempModuleHALF2()
{
    return this->Module_HALF2.senceTemp.minTemp;
}

uint16_t TempSensor::getMaxTempModuleHALF1()
{
    return this->Module_HALF1.senceTemp.maxTemp;
}

uint16_t TempSensor::getMaxTempModuleHALF2()
{
